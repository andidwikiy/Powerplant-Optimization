...
*Emission   
    ...
    Hmax(t)         Maximum allowed emission in year t /0 2500000,1 3000000,2 3500000,3 4000000,4 4500000/
;
...
PVCAP(j,k,t)..   PPV(j,k,t) =L= N(j,t) * 0.00015;

WCAP(a,k,t)..    PWT(a,k,t) =L= M(a,t) * 0.0023;
...
EMISSION(t).. Hmax(t) =G= sum((i,k),P(i,k,t)*e(i));
